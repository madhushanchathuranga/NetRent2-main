...
import { bagIcon, facebookIcon, instagramIcon, keyGrayIcon, linkedinIcon, plusIcon, pointIcon, tiktokIcon1, youtubeIcon } from '../../assets/icons';
...
const JoinAgentCard = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (e: MouseEvent) => {
            if (proposalDropDownRef.current && !proposalDropDownRef.current.contains(e.target as Node)) {
    ...
    useEffect(() => {
        const handleClickOutside = (e: MouseEvent) => {
            if (marketingProposalDropDownRef.current && !marketingProposalDropDownRef.current.contains(e.target as Node)) {
    ...
    const handleProposalSelect = (proposal: string) => {
        if (selectedProposals.includes(proposal)) {
            setSelectedProposals(selectedProposals.filter(item => item !== proposal));
        } else {
    ...
    const handleMarketingSelect = (marketing: string) => {
        if (selectedMarketing.includes(marketing)) {
            setSelectedMarketing(selectedMarketing.filter(item => item !== marketing));
        } else {
        ...
        <>
            ...
            {showRegisterModal && (
                <div className='w-full flex items-center justify-center bg-black/20 h-screen fixed top-0 left-0 z-[4000]'>
                    <div ref={modalRef} className='w-full max-w-[650px] h-full max-h-[572px] rounded-[30px] drop-shadow-md bg-white p-7 gap-2 overflow-hidden'>
                        <div className='w-full flex flex-row justify-end items-center'>
                            <div className='w-[185px] h-[32px] bg-[#FFF8E2] rounded-l-full p-py-2 px-3 rounded-r-full flex flex-row items-center gap-2 justify-between'>
                                ...
                                <img src={pointIcon} alt='Points icon' className='size-[22px]' />
                        ...
                        <form className='w-full h-[calc(100%-20px)] overflow-y-auto flex flex-col gap-12 py-5'>
                            <div className='w-full flex flex-col items-center gap-7'>
                                <div className='w-full flex flex-row items-center justify-center gap-2'>
                                    ...
                                    <div className='w-[46px] h-[22px] p-1 bg-[#FFF8E2] rounded-l-full rounded-r-full items-center justify-center flex flex-row gap-1'>
                                        <img src={pointIcon} alt='Points icon' className='size-[15px]' />
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div className='w-full h-[43px] rounded-r-full rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                        <input type='text' placeholder='123 1455 ' className='w-full text-[12px] px-4 h-full p-2 focus:outline-none' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='w-full flex flex-col items-center gap-7'>
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div className='w-full h-[43px] rounded-r-full rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                        <input type='text' placeholder='netrent@email.com' className='w-full text-[12px] px-4 h-full p-2 focus:outline-none' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='w-full flex flex-col items-center gap-7'>
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div className='w-full h-[43px] rounded-r-full rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                        <input type='text' placeholder='+6112345647' className='w-full text-[12px] px-4 h-full p-2 focus:outline-none' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='w-full flex flex-col items-center gap-7'>
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div className='w-full h-[150px] rounded-[16px] bg-white border-[#F2F2F2] border-[1px]'>
                                        <div className='w-full h-[30px] border-b-[#F2F2F2] border-b-[1px]'>

                                        </div>
                                        <textarea placeholder='lorem...' maxLength={200} className='w-full text-[12px] px-4 h-full p-2 focus:outline-none' />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div className='w-full flex flex-col gap-5'>
                                        <div className='w-full h-[43px] rounded-r-full flex flex-row gap-2 items-center p-2 rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                            <img src={facebookIcon} alt='Points icon' className='size-[20px]' />
                                            <input type='text' placeholder='facebook.com/Your profile' className='w-full text-[12px] px-2 h-full p-2 focus:outline-none' />
                                        </div>

                                        <div className='w-full h-[43px] rounded-r-full flex flex-row gap-2 items-center p-2 rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                            <img src={instagramIcon} alt='Points icon' className='size-[20px]' />
                                            <input type='text' placeholder='instagram.com/Your profile' className='w-full text-[12px] px-2 h-full p-2 focus:outline-none' />
                                        </div>

                                        <div className='w-full h-[43px] rounded-r-full flex flex-row gap-2 items-center p-2 rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                            <img src={linkedinIcon} alt='Points icon' className='size-[20px]' />
                                            <input type='text' placeholder='linkedin.com/Your profile' className='w-full text-[12px] px-2 h-full p-2 focus:outline-none' />
                                        </div>

                                        <div className='w-full h-[43px] rounded-r-full flex flex-row gap-2 items-center p-2 rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                            <img src={youtubeIcon} alt='Points icon' className='size-[20px]' />
                                            <input type='text' placeholder='youtube.com/Your profile' className='w-full text-[12px] px-2 h-full p-2 focus:outline-none' />
                                        </div>

                                        <div className='w-full h-[43px] rounded-r-full flex flex-row gap-2 items-center p-2 rounded-l-full bg-white border-[#F2F2F2] border-[1px]'>
                                            <img src={tiktokIcon1} alt='Points icon' className='size-[20px]' />
                                            <input type='text' placeholder='tiktok.com/Your profile' className='w-full text-[12px] px-2 h-full p-2 focus:outline-none' />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div className='size-[25px] bg-gray-200 rounded-full overflow-hidden flex items-center justify-center'>
                                                <img src={keyGrayIcon} alt='Key icon' className='w-[12px] h-[7px]' />
                                            </div>
                                            {selectedProposals.length > 0 ? (
                                                <div className='w-[calc(100%-30px)] flex flex-row gap-2 capitalize'>
                                                    {selectedProposals.slice(0, 1).map((proposal, index) => (
                                                        <div key={index} className='border-[#F2F2F2] border-[1px] gap-1 rounded-l-full rounded-r-full rounded-[10px] px-2 py-1 flex flex-row items-center justify-center'>
                                                            <p className='text-[min(3vw,12px)] text-[#757575] font-medium'>
                                                                {proposal}
                                                            </p>
                                                            <div
                                                                onClick={() => setSelectedProposals(selectedProposals.filter(item => item !== proposal))}
                                ...
                                <div className='w-full max-w-[422px] flex flex-col gap-1'>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            className='flex flex-row gap-4 p-2 items-center'>
                                            <div className='size-[25px] bg-gray-200 rounded-full overflow-hidden flex items-center justify-center'>
                                                <img src={bagIcon} alt='Key icon' className='w-[12px] h-[12px]' />
                                            </div>
                                            {selectedMarketing.length > 0 ? (
                                                <div className='w-[calc(100%-30px)] flex flex-wrap gap-2 capitalize'>
                                                    {selectedMarketing.slice(0, 2).map((marketing, index) => (
                                                        <div key={index} className='border-[#F2F2F2] border-[1px] gap-1 rounded-l-full rounded-r-full rounded-[10px] px-2 py-1 flex flex-row items-center justify-center'>
                                                            <p className='text-[min(3vw,12px)] text-[#757575] font-medium'>
                                                                {marketing}
                                                            </p>
                                                            <div
                                                                onClick={() => setSelectedMarketing(selectedMarketing.filter(item => item !== marketing))}
                                                                className='size-[20px] bg-gray-200 rounded-full flex items-center justify-center'>
                                                                <IoClose className='text-[#2d2d2d] size-[14px]' />
                                                            </div>
                                                        </div>
                            ...
                            <div className='w-full flex flex-col items-center gap-7 py-7'>
                                ...
                                <button className='w-full max-w-[350px] flex flex-row gap-1 text-white text-[14px] font-bold items-center justify-center bg-[#68BA6B] h-[50px] rounded-l-full rounded-r-full'>
