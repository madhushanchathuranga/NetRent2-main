...
import { c1Img, r2Img, r3Img, r4Img, r5Img, r6Img, testUser2, } from '../assets/images';
import RoomingDataInfo from '../components/rooming/RoomingDataInfo';
import RoomingViewSideCard from '../components/rooming/RoomingViewSideCard';
    ...
    const sidePropertyData = [
        {
            ...
            garageSpaces: 2,
            landSize: "350m²",
            propertyImages: [c1Img, r2Img, r3Img, r4Img, r5Img, r6Img]
        },
        {
            name: "Emma Olivia",
            rating: 4.2,
                    ...
                    <aside className="self-start gap-4 sticky top-[4px] w-full sm:h-fit col-span-1 flex flex-col items-center lg:items-start">
...

                        {
                            sidePropertyData.map((data, index) => (
                                <RoomingViewSideCard key={index} data={data} />
                            ))
                        }
                    </aside>
                </div>
