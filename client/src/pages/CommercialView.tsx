...
import CommercialDataInfo from '../components/commercial/CommercialDataInfo';
import CommercialViewSideCard from '../components/commercial/CommercialViewSideCard';
                    ...
                    <aside className="self-start gap-4 sticky top-[4px] w-full sm:h-fit col-span-1 flex flex-col items-center lg:items-start">
...

                        {
                            sidePropertyData.map((data, index) => (
                                <CommercialViewSideCard key={index} data={data} />
                            ))
                        }
                    </aside>
                </div>
